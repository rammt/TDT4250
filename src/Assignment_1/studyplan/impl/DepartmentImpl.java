 ...
 * </p>
 * <ul>
 *   <li>{@link Assignment_1.studyplan.impl.DepartmentImpl#getStudies <em>Studies</em>}</li>
 *   <li>{@link Assignment_1.studyplan.impl.DepartmentImpl#getCourses <em>Courses</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DepartmentImpl extends MinimalEObjectImpl.Container implements Department {
	 ...
	 * @ordered
	 */
	protected EList<Programme> studies;
	 ...
	 * @generated
	 */
	public EList<Programme> getStudies() {
		if (studies == null) {
			studies = new EObjectContainmentEList<Programme>(Programme.class, this, StudyplanPackage.DEPARTMENT__STUDIES);
		}
		return studies;
	}
	...
	public EList<Course> getCourses() {
		if (courses == null) {
			courses = new EObjectContainmentEList<Course>(Course.class, this, StudyplanPackage.DEPARTMENT__COURSES);
		}
		return courses;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StudyplanPackage.DEPARTMENT__STUDIES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case StudyplanPackage.DEPARTMENT__STUDIES:
				getStudies().clear();
				getStudies().addAll((Collection<? extends Programme>)newValue);
				return;
			case StudyplanPackage.DEPARTMENT__COURSES:
				getCourses().clear();
