...
public class ProgrammeImpl extends MinimalEObjectImpl.Container implements Programme {
	...
	protected EClass eStaticClass() {
		return Assignment_1Package.Literals.PROGRAMME;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment_1Package.PROGRAMME__NAME, oldName, name));
	}
	...
	public void setDuration(int newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment_1Package.PROGRAMME__DURATION, oldDuration,
					duration));
	}
	...
	public void setDegree(Degree newDegree) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment_1Package.PROGRAMME__DEGREE, oldDegree,
					degree));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Assignment_1Package.PROGRAMME__NAME:
			return getName();
