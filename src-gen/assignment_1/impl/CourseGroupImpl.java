 ...
 * </p>
 * <ul>
 *   <li>{@link assignment_1.impl.CourseGroupImpl#getType <em>Type</em>}</li>
 *   <li>{@link assignment_1.impl.CourseGroupImpl#getCourse <em>Course</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CourseGroupImpl extends MinimalEObjectImpl.Container implements CourseGroup {
	...
	protected EClass eStaticClass() {
		return Assignment_1Package.Literals.COURSE_GROUP;
	}
	...
	public void setType(CourseType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment_1Package.COURSE_GROUP__TYPE, oldType,
					type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Assignment_1Package.COURSE_GROUP__TYPE:
			return getType();
		case Assignment_1Package.COURSE_GROUP__COURSE:
			return getCourse();
		}
