...
public class Assignment_1PackageImpl extends EPackageImpl implements Assignment_1Package {
	 ...
	 */
	@Override
	public EAttribute getCourse_IsMandatory() {
	...
	public void createPackageContents() {
		...
		createEAttribute(courseEClass, COURSE__IS_MANDATORY);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCourse_CourseName(), ecorePackage.getEString(), "CourseName", null, 0, 1, Course.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCourse_IsMandatory(), ecorePackage.getEBoolean(), "IsMandatory", null, 0, 1, Course.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(studentEClass, Student.class, "Student", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getStudent_StudentNumber(), ecorePackage.getEInt(), "StudentNumber", null, 0, 1, Student.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
